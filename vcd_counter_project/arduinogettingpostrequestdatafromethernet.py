...
def vehicle_data():
    ...
    print(f"Received Data - Temperature: {temperature}, Humidity: {humidity}, Heat Index: {heat_index}")

    return jsonify({"message": "Data Received Successfully"}), 200  # Respond with JSON
